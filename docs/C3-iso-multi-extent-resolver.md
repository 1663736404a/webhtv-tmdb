...
Implementation status: complete and App-compile verified on 2026-08-27. Recorded extents are read in logical order, unrecorded extents are zero-filled, and a short extent still raises `IOException`. Mobile and Leanback arm64 Debug Java compilation passed against the published E7-2 AARs. Tests and real split MPLS/CLPI playback were omitted by user direction and remain residual validation risk.
