...
| 25 | `P4-4` | MPV | 自动播放意图与延迟 pause 回调隔离 | **已实施并通过定向验证，待原子提交/tag**：V2453A/API 35 冷启动和两次快速媒体替换均保持自动播放，两个暖切换样本约 3 秒推进约 2.8 秒；不改 native/FFmpeg/渲染链 | [P4-4-mpv-autoplay-pause-race.md](P4-4-mpv-autoplay-pause-race.md) |
